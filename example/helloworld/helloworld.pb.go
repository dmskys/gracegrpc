...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x06, 0x70, 0x62, 0x75, 0x73, 0x65, 0x72, 0x22, 0x22, 0x0a, 0x0c, 0x48, 0x65,
	...
	0x70, 0x62, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x70, 0x62, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x3b,
...
var file_helloworld_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: pbuser.HelloRequest
	(*HelloReply)(nil),   // 1: pbuser.HelloReply
}
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: pbuser.Greeter.SayHello:input_type -> pbuser.HelloRequest
	1, // 1: pbuser.Greeter.SayHello:output_type -> pbuser.HelloReply
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/pbuser.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pbuser.Greeter/SayHello",
	}
